...
public class PasilloCalaveras10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historiaDerecha.add("Mejor pillamos la derecha que la puerta está en mejor estado");
        historiaDerecha.add("");
                        ...
                        case 8:
                            ...
                            if(decision == 1){
                                if(cordura < 60){
                                    ...
                                    personaje.setVisibility(View.VISIBLE);
                                    personaje.setImageResource(R.drawable.nailaechandolabronca);
                                    txtView2.animatedText("Esto no tiene pinta de salida y si vamos por el otro lado además la puerta no tiene barrotes");
