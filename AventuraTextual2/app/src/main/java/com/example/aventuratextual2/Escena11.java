...
public class Escena11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //HISTORIA
        historia.add("Tengo una buena y una mala noticia. ¿Cuál quereis oir  primero?");
        ...
        historia.add("Tuve una vida feliz, era butanero y envidiado por todos, querido por muchos. Pero nunca encontré a mi alma gemela, tuve muchas amigas, MUCHAS, servido en la amistad, de hecho me llamaban el embajador de la friendzone…");
