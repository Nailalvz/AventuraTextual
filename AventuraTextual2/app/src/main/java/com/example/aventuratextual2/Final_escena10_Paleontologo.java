...
public class Final_escena10_Paleontologo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_escena10_paleontologo);
            ...
            public void onClick(View view) {
                switch (escena){
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        Intent intent = new Intent(Final_escena10_Paleontologo.this, MainActivity2_Final.class);
